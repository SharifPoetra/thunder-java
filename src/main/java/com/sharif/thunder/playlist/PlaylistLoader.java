package com.sharif.thunder.playlist;
...
public class PlaylistLoader {
    ...
    public List<String> getPlaylistNames() {
        if (folderExists()) {
            ...
            return Arrays.asList(
                            folder.listFiles((pathname) -> pathname.getName().endsWith(".txt")))
                    .stream()
    ...
    public class Playlist {
        ...
        private final List<AudioTrack> tracks = new LinkedList<AudioTrack>();
        private final List<PlaylistLoadError> errors = new LinkedList<PlaylistLoadError>();
                            ...
                            new AudioLoadResultHandler() {
                                ...
                                public void playlistLoaded(AudioPlaylist ap) {
                                    if (ap.isSearchResult()) {
                                        ...
                                        List<AudioTrack> loaded =
                                                new ArrayList<AudioTrack>(ap.getTracks());
                                        if (shuffle)
                                ...
                                public void noMatches() {
                                    errors.add(
                                            new PlaylistLoadError(
                                                    index, items.get(index), "No matches found."));
                                    if (last && callback != null) callback.run();
                                }
