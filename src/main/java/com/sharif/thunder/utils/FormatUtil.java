...
public class FormatUtil {
  ...
  public static String formatHelp(Thunder thunder, CommandEvent event) {
    StringBuilder builder = new StringBuilder(thunder.getConfig().getSuccess()+" __**"+event.getSelfUser().getName()+"** commands:__\n");
    ...
    builder.append("\n\nDo not include <> nor [] - <> means required and [] means optional."
                   + "\nFor additional help, contact **" + event.getJDA().getUserById(event.getClient().getOwnerId()).getName() + "**#" + event.getJDA().getUserById(event.getClient().getOwnerId()).getDiscriminator() + "");
