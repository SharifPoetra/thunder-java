...
public class RemoveCommand extends MusicCommand {
  ...
  public void doCommand(CommandEvent event) {
    ...
    if(qt.getIdentifier()==event.getAuthor().getIdLong()) {
      ...
      event.replyError("You cannot remove **"+qt.getTrack().getInfo().title+"** because you don't have `Manage Server` permission and you're not the requester of that song!");
    }
  }
}