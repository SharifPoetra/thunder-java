...
import com.sharif.thunder.utils.RequestHandler;
    ...
    protected void execute(CommandEvent event) {
        try {
            ...
            final String ageRating =
                    data.get("ageRating").getAsString()
                            + ": "
                            + data.get("ageRatingGuide").getAsString();
                            ...
                            .setTitle(
                                    ...
                                    (data.get("youtubeVideoId").isJsonNull())
                                            ...
                                            : "https://www.youtube.com/watch?v="
                                                    + data.get("youtubeVideoId").toString())
                            .setImage(
                                    data.get("posterImage")
                                            .getAsJsonObject()
                                            .get("medium")
                                            .getAsString())
